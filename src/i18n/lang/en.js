export default {
  login: {
    ...
    passwordkong: 'The password cannot be empty',
    passwordshuzi: 'Only numbers can be entered in the password',
    logindenglu: 'Logging in indicates your consent',
    loginfuwu: '《terms of service》',
    loginjizhu: 'Remember to log in next time',
    permission: 'Test permission Account',
    desc: `
  ...
  toast: {
    ...
    successfully: 'land successfully',
    success: 'Exit the success',
    confirmzhiyi: 'Are you sure you want to log out?',
    tishi: 'hint',
    successquxiao: 'Canceling Logout Succeeded'
  },
  tagsView: {
    refresh: 'Refresh',
